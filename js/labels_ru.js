...
/* ---------- РУССКИЙ ---------- */
registerLang("ru", { name:"RUS", transField:"trans", tKeysField:"tKeys" }, {
  ...
  ansModeTitle:"✍️ Как отвечать", ansModeSub:"для поля Perfekt", ansModeSub_prep:"для поля «предлог + падеж»",
