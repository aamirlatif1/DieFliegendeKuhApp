...
- Иллюстрации — `.webp`, ~800×1200 px, отдельные файлы в папке `verb-images/NNN-infinitiv.webp` (например `verb-images/001-abbrechen.webp`; полный список имён — в `verb-images/README.md`), подбираются вручную и не входят в репозиторий; без файла карточка показывает нейтральную заглушку.
